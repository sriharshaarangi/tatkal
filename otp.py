...
driver.find_element_by_css_selector('tr>td>input[name="otp"]').click()
...
class MyFrame2 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"OTP", pos = wx.Point( 50,50 ), size = wx.Size( 400,150 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.captcha_1 = wx.StaticText( self, wx.ID_ANY, u"Enter OTP", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.refresh_captcha = wx.Button( self, ID, u"", wx.DefaultPosition, wx.DefaultSize, 0 )
...
#driver.find_element_by_id('optId').click()
cap=driver.find_element_by_css_selector('tr>td>[name="loginotp"]')
#cap=driver.find_element_by_class_name('loginCaptcha')
cap.send_keys(ir_ca)#entering captcha 
login =driver.find_element_by_css_selector('tr>td>[name="j_idt119:j_idt123"]').click()#auto login
...
class MyFrame3 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"OTP" , pos = wx.Point( 50,50 ), size = wx.Size( 600,150 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
